...
| [`21-journal-replay-and-live-loop-fold.md`](21-journal-replay-and-live-loop-fold.md) | 2026-09-09 | Journal replay of the July–August fills into the live walk-forward, `scripts/live_loop/` retired into `scripts/journal/lib/mapping.py` |
...
| 2026-09-09 — journal — the July to mid-August fills are journalled; the live walk-forward has 55 mapped rows over 20 signal dates | [archive/21](21-journal-replay-and-live-loop-fold.md) |
| 2026-09-09 — journal — `scripts/live_loop/` is gone; its rules module is `scripts/journal/lib/mapping.py` and speaks the journal's own types | [archive/21](21-journal-replay-and-live-loop-fold.md) |
