...
Run:
    ...
    python -m scripts.backtest_study.f1_selection.bear_arm | tee backtests/study_output/bear_arm.txt
"""
...
# The FROZEN exit grid — copied from scripts/backtest_study/f2_management/exit_mechanism_study.py
