...
_SCORE_LEGEND_DOC = Path(__file__).parent.parent.parent / "config" / "prompts" / "conviction-score-legend.md"
...
def _score_legend() -> str:
    try:
        ...
        return "> Conviction score: see config/prompts/conviction-score-legend.md"
