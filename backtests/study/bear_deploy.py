...
Run:
    ...
    python -m backtests.study.bear_deploy | tee backtests/study/output/bear_deploy.txt
"""
...
from backtests.study.bear_arm import BEAR_STRUCTURES, clause_vocabulary  # noqa: E402
