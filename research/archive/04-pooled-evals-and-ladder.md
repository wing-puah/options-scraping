...
## 2026-07-19 — Deployment ladder: capital-constrained live selection rule (docs/deployment-rules.md)
...
**The ladder** (full operator doc: `docs/deployment-rules.md`):
...
**Decisions**: `docs/deployment-rules.md` written as the operator
