...
the standing follow-up (recipe in `research/analysis-roadmap.md`, alpha
attribution).
...
`docs/conviction-score.md`), `cpir` r ≈ −0.20, `iv_pct` r ≈ −0.16,
...
5. ~~**iv_pct veto: rejected as a hard gate**~~ — **DONE 2026-07-13.**
   ...
   docs/conviction-score.md §IV percentile now states the veto was
...
- **`config/prompts/analysis-framework.md` Step 5** — Vol-alignment rubric rewritten:
...
- **`config/prompts/analysis-framework.md` Step 4** — explicit decoupling rule:
