...
_Status: historical (covers 2026-08-28 → 2026-09-02). Conclusions stand as of 2026-09-04. Superseded / qualified by: [current.md §2026-09-04](../current.md) and [next-steps.md §2.1](../next-steps.md) — `hedge_concentration` is no longer an ungraded first run: it was re-run on a larger export (ADMITTED 225 / 112 dates) and GRADED under the two-analyst protocol on 2026-09-04 with the PRECONDITION-NULL verdict unchanged, and the max-drawdown hedge question is CLOSED; that entry also records the closing note this volume lacks — everything powered in the hedge programme is about the TRIGGER, and the INSTRUMENT has never been powered, so "not shown to work" is the absence of a measurement, not a measurement of absence; [current.md §2026-09-04](../current.md) and [next-steps.md §2.0](../next-steps.md) — every "module unwritten" / "no module" statement about `concurrency_correlation` here is superseded: it was built and first-run 2026-09-04, `VERDICT: NOISE`, all 11 powered arms inside ARM N's band. The `hedge_timing`, `hedge_exposure`, `exit_basis` and text-loop conclusions stand. Live record: [current.md](../current.md)._
...
[`pre-registrations/f5_hedging/hedge_concentration.md`](../pre-registrations/f5_hedging/hedge_concentration.md),
...
[`study-results/f5_hedging/hedge_concentration.md`](../study-results/f5_hedging/hedge_concentration.md).
