...
OPEN — see [`archive/02`](02-credit-debit-split-attempts-8-12.md)
...
| ChatGPT P4 / Test D — wider stops, days-to-MFE-after-exit | **SUPERSEDED** | absorbed into the exit-conditioning work, [`archive/11`](11-exit-conditioning.md); the surviving open piece is the bear sub-0.50 give-back, [`next-steps.md`](../next-steps.md) §2.4 |
...
[`archive/07`](07-bear-put-demotion-thread-and-holdout.md) addenda
