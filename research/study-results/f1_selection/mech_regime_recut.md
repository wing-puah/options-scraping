# mech_regime_recut — per-era record

**Question.** Does a deterministic regime label — a pure function of SPY/VIX history at the signal date — beat the model's free-text regime?
...
run         2026-08-15 23:45:13 · git 53b7167 (main, working tree dirty) · exit 0 · 1.0s
...
run         2026-08-22 18:10:24 · git d47e227 (main, working tree dirty) · exit 0 · 0.8s
command     python -m scripts.backtest_study.f1_selection.mech_regime_recut
excerpt     matched
...
run         2026-08-27 21:13:08 · git 25f3e27 (main, working tree dirty) · exit 0 · 1.0s
command     python -m scripts.backtest_study.f1_selection.mech_regime_recut
excerpt     matched
...
run         2026-09-04 20:36:23 · git e59356f (main, working tree dirty) · exit 0 · 0.7s
command     python -m scripts.backtest_study.f1_selection.mech_regime_recut
excerpt     matched
...
run         2026-09-19 23:27:39 · git 8e9b6a7 (main, working tree clean) · exit 0 · 1.2s
command     python -m scripts.backtest_study.f1_selection.mech_regime_recut
excerpt     matched
