...
run         2026-08-24 18:23:01 · git c841a01 (main, working tree dirty) · exit 0 · 1.9s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
...
run         2026-08-27 20:42:40 · git 25f3e27 (main, working tree dirty) · exit 0 · 2.9s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
...
population  535 results · 1,303 proxy · 2,212 analysis · 819 spy_vix_daily_full  (inputs dated 2026-09-04 11:10 … 2026-09-04 20:31)
run         2026-09-04 22:26:42 · git b007f95 (main, working tree clean) · exit 0 · 4.7s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
...
## era v4 · inputs 76cc867 · sha d69a802 — recorded 2026-09-05
<!-- key era=v4 sha=d69a802 inputs=76cc867 -->

population  535 results · 1,303 proxy · 2,212 analysis · 820 spy_vix_daily_full  (inputs dated 2026-09-04 23:34 … 2026-09-05 09:48)
run         2026-09-05 16:33:43 · git d69a802 (main, working tree dirty) · exit 0 · 4.6s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
...
run         2026-09-19 23:50:24 · git 8e9b6a7 (main, working tree clean) · exit 0 · 5.0s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
...
population  598 results · 1,665 proxy · 2,781 analysis · 827 spy_vix_daily_full  (inputs dated 2026-09-16 11:32 … 2026-09-19 16:45)
run         2026-09-20 12:15:44 · git 1c163c5 (main, working tree clean) · exit 0 · 8.6s
command     python -m scripts.backtest_study.f4_deployment.account_sim
excerpt     verdict
