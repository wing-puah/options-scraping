# exit_switch_structure_study — per-era record

**Question.** Q1 — does a bear_put-keyed trail pass the same ship gate? Q2 — is BEAR_HE secretly just a composition proxy for that structure effect?
...
run         2026-08-15 23:45:58 · git 53b7167 (main, working tree dirty) · exit 0 · 2.6s
...
run         2026-08-22 18:10:43 · git d47e227 (main, working tree dirty) · exit 0 · 2.2s
command     python -m scripts.backtest_study.f2_management.exit_switch_structure_study
excerpt     matched
...
run         2026-08-24 18:20:58 · git c841a01 (main, working tree dirty) · exit 0 · 1.4s
command     python -m scripts.backtest_study.f2_management.exit_switch_structure_study
excerpt     matched
...
run         2026-09-04 20:38:53 · git e59356f (main, working tree dirty) · exit 0 · 1.7s
command     python -m scripts.backtest_study.f2_management.exit_switch_structure_study
excerpt     matched
...
run         2026-09-19 23:32:55 · git 8e9b6a7 (main, working tree clean) · exit 0 · 3.0s
command     python -m scripts.backtest_study.f2_management.exit_switch_structure_study
excerpt     matched
