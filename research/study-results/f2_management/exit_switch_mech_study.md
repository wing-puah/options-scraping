# exit_switch_mech_study — per-era record

**Question.** A per-regime exit switch keyed on the mechanical regime — is it stable where the model-keyed version failed leave-one-out?
...
run         2026-08-15 23:45:56 · git 53b7167 (main, working tree dirty) · exit 0 · 2.7s
...
run         2026-08-22 18:10:40 · git d47e227 (main, working tree dirty) · exit 0 · 2.4s
command     python -m scripts.backtest_study.f2_management.exit_switch_mech_study
excerpt     matched
...
run         2026-08-24 18:20:56 · git c841a01 (main, working tree dirty) · exit 0 · 1.4s
command     python -m scripts.backtest_study.f2_management.exit_switch_mech_study
excerpt     matched

```
    NOT EVALUABLE on this book: 1 of 25 affected dates — the census above IS the recorded result (pre-registration §Census-first rule: 'a trigger who…
    VERDICT: mech-keyed per-regime exit switch STAYS GATED.
    VERDICT: LVOL (tef null) CLEARED.
```
...
run         2026-08-27 23:00:15 · git 25f3e27 (main, working tree dirty) · exit 0 · 7.1s
command     python -m scripts.backtest_study.f2_management.exit_switch_mech_study
excerpt     matched
...
run         2026-09-04 20:38:51 · git e59356f (main, working tree dirty) · exit 0 · 1.9s
command     python -m scripts.backtest_study.f2_management.exit_switch_mech_study
excerpt     matched
