...
run         2026-08-27 20:39:23 · git 25f3e27 (main, working tree dirty) · exit 0 · 177.3s
command     python -m scripts.backtest_study.f3_structure.financed_spread
excerpt     matched
...
run         2026-09-04 21:48:12 · git e59356f (main, working tree dirty) · exit 0 · 421.2s
command     python -m scripts.backtest_study.f3_structure.financed_spread
excerpt     matched
...
run         2026-09-19 16:59:24 · git 6d8dfc6 (main, working tree dirty) · exit 0 · 523.1s
command     python -m scripts.backtest_study.f3_structure.financed_spread
excerpt     matched
