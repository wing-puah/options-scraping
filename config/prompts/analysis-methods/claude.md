...
plays, and invalidations defined in `config/prompts/analysis-framework.md`.
...
choices live in `research/analysis-roadmap.md` — chiefly a size/contracts aggregate
